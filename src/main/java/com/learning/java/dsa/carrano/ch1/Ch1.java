...
public class Ch1 {
  public static void main(String[] args) {
    MyGenericArray<Item> bag = new Bag<>();
    ...
    System.out.println("bag = " + Arrays.toString(bag.toArray()));
    var result1 = bag.remove(item2);
    System.out.println("removed = " + result1);
    System.out.println("bag after removal = " + Arrays.toString(bag.toArray()));
  }
}
